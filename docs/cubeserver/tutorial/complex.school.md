...
<xmi:XMI xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:relational="http://www.omg.org/spec/CWM/1.1/resource/relational" xmlns:rolapcat="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/catalog" xmlns:rolapcube="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/cube" xmlns:rolapdim="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/dimension" xmlns:rolaphier="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/dimension/hierarchy" xmlns:rolaplev="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/dimension/hierarchy/level" xmlns:rolapmeas="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/cube/measure" xmlns:rolapsrc="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/database/source">
  <relational:SQLSimpleType xmi:id="_sqlsimpletype_character_varying" name="CHARACTER VARYING" structuralFeature="_column_traeger_traeger_name _column_alters_gruppe_altersgruppe _column_wohnort_landkreis_bezeichnung _column_geschlecht_bezeichnung _column_bundesland_bezeichnung _column_personal_art_bezeichnung _column_einschulung_einschulung _column_foerderung_art_foerderung_art _column_klassen_wiederholung_klassenwiederholung _column_migrations_hintergrund_migrations_hintergrund _column_schul_jahr_schul_jahr _column_schul_kategorie_schul_kategorie_name _column_schule_schul_name _column_ganztags_art_schul_umfang _column_schul_abschluss_schulabschluss _column_schul_art_schulart_name _column_sonderpaed_foerderbedarf_sonderpaed_bedarf _column_traeger_art_traeger_art _column_traeger_art_traeger_kat_id _column_traeger_kategorie_traeger_kategorie" typeNumber="12"/>
  <relational:SQLSimpleType xmi:id="_sqlsimpletype_integer" name="INTEGER" structuralFeature="_column_bundesland_id _column_fact_personal_alters_gruppe_id _column_fact_schulen_anzahl_klassen _column_fact_personal_anzahl_personen _column_fact_schueler_anzahl_schueler _column_fact_schulen_anzahl_schulen _column_wohnort_landkreis_bundesland_id _column_fact_schueler_einschulung_id _column_fact_schueler_foerder_art_id _column_schule_ganztags_art_id _column_fact_personal_geschlecht_id _column_fact_schueler_geschlecht_id _column_ganztags_art_id _column_traeger_art_id _column_einschulung_id _column_schul_jahr_id _column_geschlecht_id _column_personal_art_id _column_foerderung_art_id _column_schul_abschluss_id _column_migrations_hintergrund_id _column_schul_kategorie_id _column_alters_gruppe_id _column_klassen_wiederholung_id _column_wohnort_landkreis_id _column_sonderpaed_foerderbedarf_id _column_schule_id _column_schul_art_id _column_traeger_kategorie_id _column_traeger_id _column_fact_schueler_klassen_wdh _column_fact_schueler_migrations_hg_id _column_schul_jahr_order _column_fact_personal_personal_art_id _column_fact_schueler_schul_abschluss_id _column_schule_schul_art_id _column_fact_personal_schul_jahr_id _column_fact_schulen_schul_jahr_id _column_fact_schueler_schul_jahr_id _column_schul_art_schul_kategorie_id _column_schule_schul_nummer _column_fact_schulen_schule_id _column_fact_schueler_schule_id _column_fact_personal_schule_id _column_foerderung_art_sp_foerderbedarf_id _column_traeger_traeger_art_id _column_schule_traeger_id _column_fact_schueler_wohn_lk_id" typeNumber="4"/>
  ...
  <relational:Schema xmi:id="_schema">
    ...
    <ownedElement xsi:type="relational:Table" xmi:id="_table_alters_gruppe" name="alters_gruppe">
      ...
      <feature xsi:type="relational:Column" xmi:id="_column_alters_gruppe_altersgruppe" name="altersgruppe" type="_sqlsimpletype_character_varying"/>
    </ownedElement>
    ...
    <ownedElement xsi:type="relational:Table" xmi:id="_table_klassen_wiederholung" name="klassen_wiederholung">
      ...
      <feature xsi:type="relational:Column" xmi:id="_column_klassen_wiederholung_klassenwiederholung" name="klassenwiederholung" type="_sqlsimpletype_character_varying"/>
    </ownedElement>
  ...
  <rolapsrc:JoinSource xmi:id="_joinsource">
    ...
    <right xmi:id="_joinedqueryelement_id_7" key="_column_traeger_art_id" source="_joinsource_1"/>
  </rolapsrc:JoinSource>
  <rolapsrc:JoinSource xmi:id="_joinsource_1">
    ...
    <right xmi:id="_joinedqueryelement_id" key="_column_traeger_kategorie_id" source="_tablesource_traeger_kategorie"/>
  </rolapsrc:JoinSource>
  <rolapsrc:JoinSource xmi:id="_joinsource_2">
    ...
    <right xmi:id="_joinedqueryelement_id_5" key="_column_sonderpaed_foerderbedarf_id" source="_tablesource_sonderpaed_foerderbedarf"/>
  </rolapsrc:JoinSource>
  <rolapsrc:JoinSource xmi:id="_joinsource_3">
    ...
    <right xmi:id="_joinedqueryelement_id_2" key="_column_bundesland_id" source="_tablesource_bundesland"/>
  </rolapsrc:JoinSource>
  ...
  <rolapsrc:JoinSource xmi:id="_joinsource_5">
    ...
    <right xmi:id="_joinedqueryelement_id_1" key="_column_ganztags_art_id" source="_tablesource_ganztags_art"/>
  </rolapsrc:JoinSource>
  <rolapsrc:JoinSource xmi:id="_joinsource_6">
    ...
    <right xmi:id="_joinedqueryelement_id_3" key="_column_traeger_id" source="_joinsource"/>
  </rolapsrc:JoinSource>
  <rolapsrc:JoinSource xmi:id="_joinsource_7">
    ...
    <right xmi:id="_joinedqueryelement_id_4" key="_column_schul_art_id" source="_joinsource_4"/>
  </rolapsrc:JoinSource>
  ...
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_schulen_nach_art" name="Schulen nach Art" allMemberName="Alle Schulen" primaryKey="_column_schule_id" source="_joinsource_7" levels="_level_schulkategorie _level_schulart _level_schule"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_schulen_nach_ganztagsangebot" name="Schulen nach Ganztagsangebot" allMemberName="Alle Schulen" primaryKey="_column_schule_id" source="_joinsource_5" levels="_level_art_des_ganztagsangebots _level_schule_2"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_schulen_nach_tr_gerschaft" name="Schulen nach Trägerschaft" allMemberName="Alle Schulen" primaryKey="_column_schule_id" source="_joinsource_6" levels="_level_schultr_ger_kategorie _level_schultr_ger_art _level_schultr_ger _level_schule_1"/>
  ...
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_sonderp_dagogische_f_rderung" name="Sonderpädagogische Förderung" allMemberName="Gesamt" primaryKey="_column_foerderung_art_id" source="_joinsource_2" levels="_level_f_rderbedarf _level_art_der_f_rderung"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_wohnlandkreis" name="Wohnlandkreis" allMemberName="Alle Wohnlandkreise" primaryKey="_column_wohnort_landkreis_id" source="_joinsource_3" levels="_level_bundesland _level_wohnlandkreis"/>
  ...
  <rolapcube:PhysicalCube xmi:id="_physicalcube_p_dagogisches_personal_an_jenaer_schulen" name="Pädagogisches Personal an Jenaer Schulen" source="_tablesource_fact_personal">
    <dimensionConnectors xmi:id="_dimensionconnector_schulen_2" foreignKey="_column_fact_personal_schule_id" dimension="_standarddimension_schulen" overrideDimensionName="Schulen"/>
