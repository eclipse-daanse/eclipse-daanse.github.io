...
<xmi:XMI xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:relational="http://www.omg.org/spec/CWM/1.1/resource/relational" xmlns:rolapcat="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/catalog" xmlns:rolapcube="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/cube" xmlns:rolapdim="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/dimension" xmlns:rolaphier="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/dimension/hierarchy" xmlns:rolaplev="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/dimension/hierarchy/level" xmlns:rolapmeas="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/cube/measure" xmlns:rolapsrc="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/database/source">
  <relational:SQLSimpleType xmi:id="_sqlsimpletype_integer" name="INTEGER" structuralFeature="_column_schul_art_schul_kategorie_id _column_schule_traeger_id _column_fact_schueler_foerder_art_id _column_traeger_traeger_art_id _column_schul_abschluss_id _column_fact_schueler_klassen_wdh _column_schul_art_id _column_schule_id _column_personal_art_id _column_fact_schulen_anzahl_schulen _column_geschlecht_bezeichnung _column_wohnort_landkreis_bundesland_id _column_traeger_art_id _column_foerderung_art_sp_foerderbedarf_id _column_einschulung_id _column_schul_art_id_1 _column_fact_schulen_schule_id _column_migrations_hintergrund_id _column_fact_schulen_anzahl_klassen _column_fact_personal_alters_gruppe_id _column_fact_personal_schule_id _column_ganztags_art_id _column_wohnort_landkreis_id _column_fact_personal_schul_jahr_id _column_schul_kategorie_id _column_geschlecht_id _column_schule_schul_nummer _column_schule_ganztags_art_id _column_fact_personal_personal_art_id _column_traeger_id _column_schul_jahr_order _column_fact_schueler_schul_abschluss_id _column_fact_schulen_schul_jahr_id _column_fact_personal_geschlecht_id _column_fact_schueler_schul_jahr_id _column_foerderung_art_id _column_fact_schueler_wohn_lk_id _column_fact_schueler_anzahl_schueler _column_fact_schueler_geschlecht_id _column_fact_personal_anzahl_personen _column_bundesland_id _column_traeger_kategorie_id _column_fact_schueler_schule_id _column_fact_schueler_einschulung_id _column_klassen_wiederholung_klassenwiederholung _column_schul_jahr_id _column_sonderpaed_foerderbedarf_id _column_schule_schul_art_id _column_fact_schueler_migrations_hg_id _column_alters_gruppe_id _column_klassen_wiederholung_id _column_alters_gruppe_altersgruppe" typeNumber="4"/>
  <relational:SQLSimpleType xmi:id="_sqlsimpletype_character_varying" name="CHARACTER VARYING" structuralFeature="_column_einschulung_einschulung _column_traeger_kategorie_traeger_kategorie _column_migrations_hintergrund_migrations_hintergrund _column_traeger_traeger_name _column_schul_art_schulart_name _column_schul_abschluss_schulabschluss _column_sonderpaed_foerderbedarf_sonderpaed_bedarf _column_bundesland_bezeichnung _column_schul_kategorie_schul_kategorie_name _column_traeger_art_traeger_art _column_foerderung_art_foerderung_art _column_ganztags_art_schul_umfang _column_personal_art_bezeichnung _column_wohnort_landkreis_bezeichnung _column_traeger_art_traeger_kat_id _column_schul_jahr_schul_jahr _column_schule_schul_name" typeNumber="12"/>
  ...
  <rolapsrc:TableSource xmi:id="_tablesource_schul_art" table="_table_schul_art_1"/>
  ...
  <rolapsrc:JoinSource xmi:id="_joinsource">
    ...
    <right xmi:id="_joinedqueryelement_id_6" key="_column_traeger_art_id" source="_joinsource_1"/>
  </rolapsrc:JoinSource>
  <rolapsrc:JoinSource xmi:id="_joinsource_1">
    ...
    <right xmi:id="_joinedqueryelement_id_3" key="_column_traeger_kategorie_id" source="_tablesource_traeger_kategorie"/>
  </rolapsrc:JoinSource>
  ...
  <rolapsrc:JoinSource xmi:id="_joinsource_3">
    ...
    <right xmi:id="_joinedqueryelement_id_1" key="_column_schul_art_id_1" source="_joinsource_5"/>
  </rolapsrc:JoinSource>
  <rolapsrc:JoinSource xmi:id="_joinsource_4">
    ...
    <right xmi:id="_joinedqueryelement_id_7" key="_column_ganztags_art_id" source="_tablesource_ganztags_art"/>
  </rolapsrc:JoinSource>
  <rolapsrc:JoinSource xmi:id="_joinsource_5">
    ...
    <right xmi:id="_joinedqueryelement_id" key="_column_schul_kategorie_id" source="_tablesource_schul_kategorie"/>
  </rolapsrc:JoinSource>
  <rolapsrc:JoinSource xmi:id="_joinsource_6">
    ...
    <right xmi:id="_joinedqueryelement_id_4" key="_column_traeger_id" source="_joinsource"/>
  </rolapsrc:JoinSource>
  ...
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_schulen_nach_ganztagsangebot" name="Schulen nach Ganztagsangebot" allMemberName="Alle Schulen" primaryKey="_column_schule_id" source="_joinsource_4" levels="_level_art_des_ganztagsangebots _level_schule"/>
  ...
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_schulen_nach_art" name="Schulen nach Art" allMemberName="Alle Schulen" primaryKey="_column_schule_id" source="_joinsource_3" levels="_level_schulkategorie _level_schulart _level_schule_2"/>
  ...
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_wohnlandkreis" name="Wohnlandkreis" allMemberName="Alle Wohnlandkreise" primaryKey="_column_wohnort_landkreis_id" source="_joinsource_7" levels="_level_bundesland _level_wohnlandkreis"/>
  ...
  <rolapcube:PhysicalCube xmi:id="_physicalcube_schulen_in_jena_institutionen" name="Schulen in Jena (Institutionen)" source="_tablesource_fact_schulen">
    ...
    <dimensionConnectors xmi:id="_dimensionconnector_schuljahr_2" foreignKey="_column_fact_schulen_schul_jahr_id" dimension="_standarddimension_schuljahre" overrideDimensionName="Schuljahr"/>
  ...
  <rolapcube:PhysicalCube xmi:id="_physicalcube_sch_ler_innen_an_jenaer_schulen" name="Schüler:innen an Jenaer Schulen" source="_tablesource_fact_schueler">
    <dimensionConnectors xmi:id="_dimensionconnector_schulen" foreignKey="_column_fact_schueler_schule_id" dimension="_standarddimension_schulen" overrideDimensionName="Schulen"/>
