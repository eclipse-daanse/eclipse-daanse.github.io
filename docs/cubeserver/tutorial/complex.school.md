...
<xmi:XMI xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:relational="http://www.omg.org/spec/CWM/1.1/resource/relational" xmlns:rolapcat="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/catalog" xmlns:rolapcube="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/cube" xmlns:rolapdim="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/dimension" xmlns:rolaphier="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/dimension/hierarchy" xmlns:rolaplev="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/dimension/hierarchy/level" xmlns:rolapmeas="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/cube/measure" xmlns:rolapsrc="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/database/source">
  <relational:SQLSimpleType xmi:id="_sqlsimpletype_character_varying" name="CHARACTER VARYING" structuralFeature="_column_schul_kategorie_schul_kategorie_name _column_personal_art_bezeichnung _column_geschlecht_bezeichnung _column_bundesland_bezeichnung _column_wohnort_landkreis_bezeichnung _column_einschulung_einschulung _column_foerderung_art_foerderung_art _column_migrations_hintergrund_migrations_hintergrund _column_schul_jahr_schul_jahr _column_schule_schul_name _column_ganztags_art_schul_umfang _column_schul_abschluss_schulabschluss _column_schul_art_schulart_name _column_sonderpaed_foerderbedarf_sonderpaed_bedarf _column_traeger_art_traeger_art _column_traeger_art_traeger_kat_id _column_traeger_kategorie_traeger_kategorie _column_traeger_traeger_name" typeNumber="12"/>
  <relational:SQLSimpleType xmi:id="_sqlsimpletype_integer" name="INTEGER" structuralFeature="_column_ganztags_art_id _column_fact_personal_alters_gruppe_id _column_alters_gruppe_altersgruppe _column_fact_schulen_anzahl_klassen _column_fact_personal_anzahl_personen _column_fact_schueler_anzahl_schueler _column_fact_schulen_anzahl_schulen _column_wohnort_landkreis_bundesland_id _column_fact_schueler_einschulung_id _column_fact_schueler_foerder_art_id _column_schule_ganztags_art_id _column_fact_personal_geschlecht_id _column_fact_schueler_geschlecht_id _column_bundesland_id _column_migrations_hintergrund_id _column_wohnort_landkreis_id _column_geschlecht_id _column_foerderung_art_id _column_personal_art_id _column_schul_kategorie_id _column_traeger_art_id _column_sonderpaed_foerderbedarf_id _column_alters_gruppe_id _column_traeger_kategorie_id _column_schul_abschluss_id _column_schul_jahr_id _column_schul_art_id _column_schule_id _column_klassen_wiederholung_id _column_einschulung_id _column_traeger_id _column_schul_art_id_1 _column_fact_schueler_klassen_wdh _column_klassen_wiederholung_klassenwiederholung _column_fact_schueler_migrations_hg_id _column_schul_jahr_order _column_fact_personal_personal_art_id _column_fact_schueler_schul_abschluss_id _column_schule_schul_art_id _column_fact_schueler_schul_jahr_id _column_fact_personal_schul_jahr_id _column_fact_schulen_schul_jahr_id _column_schul_art_schul_kategorie_id _column_schule_schul_nummer _column_fact_schulen_schule_id _column_fact_personal_schule_id _column_fact_schueler_schule_id _column_foerderung_art_sp_foerderbedarf_id _column_traeger_traeger_art_id _column_schule_traeger_id _column_fact_schueler_wohn_lk_id" typeNumber="4"/>
  <rolapcat:Catalog xmi:id="_catalog_daanse_example_schulwesen" name="Daanse Example - Schulwesen" cubes="_physicalcube_schulen_in_jena_institutionen _physicalcube_p_dagogisches_personal_an_jenaer_schulen _physicalcube_sch_ler_innen_an_jenaer_schulen" dbschemas="_schema"/>
  <relational:Schema xmi:id="_schema">
    ...
    <ownedElement xsi:type="relational:Table" xmi:id="_table_geschlecht" name="geschlecht">
      ...
      <feature xsi:type="relational:Column" xmi:id="_column_geschlecht_bezeichnung" name="bezeichnung" type="_sqlsimpletype_character_varying"/>
    </ownedElement>
  ...
  <rolapsrc:JoinSource xmi:id="_joinsource">
    <left xmi:id="_joinedqueryelement_sp_foerderbedarf_id" key="_column_foerderung_art_sp_foerderbedarf_id" source="_tablesource_foerderung_art"/>
    <right xmi:id="_joinedqueryelement_id_4" key="_column_sonderpaed_foerderbedarf_id" source="_tablesource_sonderpaed_foerderbedarf"/>
  </rolapsrc:JoinSource>
  <rolapsrc:JoinSource xmi:id="_joinsource_1">
    <left xmi:id="_joinedqueryelement_traeger_kat_id" key="_column_traeger_art_traeger_kat_id" source="_tablesource_traeger_art"/>
    <right xmi:id="_joinedqueryelement_id_2" key="_column_traeger_kategorie_id" source="_tablesource_traeger_kategorie"/>
  </rolapsrc:JoinSource>
  <rolapsrc:JoinSource xmi:id="_joinsource_2">
    <left xmi:id="_joinedqueryelement_bundesland_id" key="_column_wohnort_landkreis_bundesland_id" source="_tablesource_wohnort_landkreis"/>
    <right xmi:id="_joinedqueryelement_id_1" key="_column_bundesland_id" source="_tablesource_bundesland"/>
  </rolapsrc:JoinSource>
  <rolapsrc:JoinSource xmi:id="_joinsource_3">
    <left xmi:id="_joinedqueryelement_schul_art_id" key="_column_schule_schul_art_id" source="_tablesource_schule"/>
    <right xmi:id="_joinedqueryelement_id_7" key="_column_schul_art_id" source="_joinsource_6"/>
  </rolapsrc:JoinSource>
  <rolapsrc:JoinSource xmi:id="_joinsource_4">
    <left xmi:id="_joinedqueryelement_ganztags_art_id" key="_column_schule_ganztags_art_id" source="_tablesource_schule"/>
    <right xmi:id="_joinedqueryelement_id_3" key="_column_ganztags_art_id" source="_tablesource_ganztags_art"/>
  </rolapsrc:JoinSource>
  <rolapsrc:JoinSource xmi:id="_joinsource_5">
    <left xmi:id="_joinedqueryelement_traeger_art_id" key="_column_traeger_traeger_art_id" source="_tablesource_traeger"/>
    <right xmi:id="_joinedqueryelement_id_5" key="_column_traeger_art_id" source="_joinsource_1"/>
  </rolapsrc:JoinSource>
  <rolapsrc:JoinSource xmi:id="_joinsource_6">
    <left xmi:id="_joinedqueryelement_schul_kategorie_id" key="_column_schul_art_schul_kategorie_id" source="_tablesource_schul_art"/>
    <right xmi:id="_joinedqueryelement_id_6" key="_column_schul_kategorie_id" source="_tablesource_schul_kategorie"/>
  </rolapsrc:JoinSource>
  <rolapsrc:JoinSource xmi:id="_joinsource_7">
    <left xmi:id="_joinedqueryelement_traeger_id" key="_column_schule_traeger_id" source="_tablesource_schule"/>
    <right xmi:id="_joinedqueryelement_id" key="_column_traeger_id" source="_joinsource_5"/>
  </rolapsrc:JoinSource>
  ...
  <rolaplev:Level xmi:id="_level_schulart" name="Schulart" column="_column_schul_art_id_1" nameColumn="_column_schul_art_schulart_name"/>
  ...
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_altersgruppen" name="Altersgruppen" allMemberName="Alle Altersgruppen" primaryKey="_column_alters_gruppe_id" source="_tablesource_alters_gruppe" levels="_level_altersgruppe"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_berufsgruppen" name="Berufsgruppen" allMemberName="Alle Berufsgruppen" primaryKey="_column_personal_art_id" source="_tablesource_personal_art" levels="_level_berufsgruppe"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_einschulung" name="Einschulung" allMemberName="Gesamt" primaryKey="_column_einschulung_id" source="_tablesource_einschulung" levels="_level_einschulung"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_geschlecht" name="Geschlecht" allMemberName="Alle Geschlechter" primaryKey="_column_geschlecht_id" source="_tablesource_geschlecht" levels="_level_geschlecht"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_klassenwiederholung" name="Klassenwiederholung" allMemberName="Gesamt" primaryKey="_column_klassen_wiederholung_id" source="_tablesource_klassen_wiederholung" levels="_level_klassenwiederholung"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_migrationshintergrund" name="Migrationshintergrund" allMemberName="Gesamt" primaryKey="_column_migrations_hintergrund_id" source="_tablesource_migrations_hintergrund" levels="_level_migrationshintergrund"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_schulabschl_sse" name="Schulabschlüsse" allMemberName="Gesamt" primaryKey="_column_schul_abschluss_id" source="_tablesource_schul_abschluss" levels="_level_schulabschl_sse"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_schulen_nach_art" name="Schulen nach Art" allMemberName="Alle Schulen" primaryKey="_column_schule_id" source="_joinsource_3" levels="_level_schulkategorie _level_schulart _level_schule_1"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_schulen_nach_ganztagsangebot" name="Schulen nach Ganztagsangebot" allMemberName="Alle Schulen" primaryKey="_column_schule_id" source="_joinsource_4" levels="_level_art_des_ganztagsangebots _level_schule_2"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_schulen_nach_tr_gerschaft" name="Schulen nach Trägerschaft" allMemberName="Alle Schulen" primaryKey="_column_schule_id" source="_joinsource_7" levels="_level_schultr_ger_kategorie _level_schultr_ger_art _level_schultr_ger _level_schule"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_schuljahre" name="Schuljahre" hasAll="false" primaryKey="_column_schul_jahr_id" source="_tablesource_schul_jahr" levels="_level_schuljahr"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_sonderp_dagogische_f_rderung" name="Sonderpädagogische Förderung" allMemberName="Gesamt" primaryKey="_column_foerderung_art_id" source="_joinsource" levels="_level_f_rderbedarf _level_art_der_f_rderung"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_wohnlandkreis" name="Wohnlandkreis" allMemberName="Alle Wohnlandkreise" primaryKey="_column_wohnort_landkreis_id" source="_joinsource_2" levels="_level_bundesland _level_wohnlandkreis"/>
  ...
  <rolapcube:PhysicalCube xmi:id="_physicalcube_p_dagogisches_personal_an_jenaer_schulen" name="Pädagogisches Personal an Jenaer Schulen" source="_tablesource_fact_personal">
    <dimensionConnectors xmi:id="_dimensionconnector_schulen" foreignKey="_column_fact_personal_schule_id" dimension="_standarddimension_schulen" overrideDimensionName="Schulen"/>
    <dimensionConnectors xmi:id="_dimensionconnector_schuljahr_2" foreignKey="_column_fact_personal_schul_jahr_id" dimension="_standarddimension_schuljahre" overrideDimensionName="Schuljahr"/>
    ...
    <dimensionConnectors xmi:id="_dimensionconnector_geschlecht_1" foreignKey="_column_fact_personal_geschlecht_id" dimension="_standarddimension_geschlecht" overrideDimensionName="Geschlecht"/>
  ...
  <rolapcube:PhysicalCube xmi:id="_physicalcube_schulen_in_jena_institutionen" name="Schulen in Jena (Institutionen)" source="_tablesource_fact_schulen">
    <dimensionConnectors xmi:id="_dimensionconnector_schulen_2" foreignKey="_column_fact_schulen_schule_id" dimension="_standarddimension_schulen" overrideDimensionName="Schulen"/>
    <dimensionConnectors xmi:id="_dimensionconnector_schuljahr_1" foreignKey="_column_fact_schulen_schul_jahr_id" dimension="_standarddimension_schuljahre" overrideDimensionName="Schuljahr"/>
  ...
  <rolapcube:PhysicalCube xmi:id="_physicalcube_sch_ler_innen_an_jenaer_schulen" name="Schüler:innen an Jenaer Schulen" source="_tablesource_fact_schueler">
    <dimensionConnectors xmi:id="_dimensionconnector_schulen_1" foreignKey="_column_fact_schueler_schule_id" dimension="_standarddimension_schulen" overrideDimensionName="Schulen"/>
    <dimensionConnectors xmi:id="_dimensionconnector_schuljahr" foreignKey="_column_fact_schueler_schul_jahr_id" dimension="_standarddimension_schuljahre" overrideDimensionName="Schuljahr"/>
    <dimensionConnectors xmi:id="_dimensionconnector_geschlecht" foreignKey="_column_fact_schueler_geschlecht_id" dimension="_standarddimension_geschlecht" overrideDimensionName="Geschlecht"/>
