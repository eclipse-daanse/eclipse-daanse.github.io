...
<relational:Schema xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI"  xmlns:relational="http://www.omg.org/spec/CWM/1.1/resource/relational" xmi:id="_schema">
  <ownedElement xsi:type="relational:Table" xmi:id="_table_fact" name="Fact">
    ...
    <feature xsi:type="relational:Column" xmi:id="_column_fact_salesterritorykey" name="SalesTerritoryKey" isNullable="columnNullable"/>
  ...
  <ownedElement xsi:type="relational:Table" xmi:id="_table_customer" name="Customer">
    ...
    <feature xsi:type="relational:Column" xmi:id="_column_customer_middlename" name="MiddleName" isNullable="columnNullable"/>
    ...
    <feature xsi:type="relational:Column" xmi:id="_column_customer_suffix" name="Suffix" isNullable="columnNullable"/>
    ...
    <feature xsi:type="relational:Column" xmi:id="_column_customer_addressline2" name="AddressLine2" isNullable="columnNullable"/>
  ...
  <ownedElement xsi:type="relational:Table" xmi:id="_table_employee" name="Employee">
    ...
    <feature xsi:type="relational:Column" xmi:id="_column_employee_parentemployeenationalidalternatekey" name="ParentEmployeeNationalIDAlternateKey" isNullable="columnNullable"/>
    <feature xsi:type="relational:Column" xmi:id="_column_employee_salesterritorykey" name="SalesTerritoryKey" isNullable="columnNullable"/>
    ...
    <feature xsi:type="relational:Column" xmi:id="_column_employee_middlename" name="MiddleName" isNullable="columnNullable"/>
    ...
    <feature xsi:type="relational:Column" xmi:id="_column_employee_enddate" name="EndDate" isNullable="columnNullable"/>
  ...
  <ownedElement xsi:type="relational:Table" xmi:id="_table_geography" name="Geography">
    ...
    <feature xsi:type="relational:Column" xmi:id="_column_geography_stateprovincecode" name="StateProvinceCode" isNullable="columnNullable"/>
    ...
    <feature xsi:type="relational:Column" xmi:id="_column_geography_salesterritorykey" name="SalesTerritoryKey" isNullable="columnNullable"/>
  </ownedElement>
  <ownedElement xsi:type="relational:Table" xmi:id="_table_product" name="Product">
    ...
    <feature xsi:type="relational:Column" xmi:id="_column_product_sizerange" name="SizeRange" isNullable="columnNullable"/>
    ...
    <feature xsi:type="relational:Column" xmi:id="_column_product_productline" name="ProductLine" isNullable="columnNullable"/>
    ...
    <feature xsi:type="relational:Column" xmi:id="_column_product_enddate" name="EndDate" isNullable="columnNullable"/>
...
<xmi:XMI xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI"  xmlns:relational="http://www.omg.org/spec/CWM/1.1/resource/relational" xmlns:rolapcube="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/cube" xmlns:rolapdim="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/dimension" xmlns:rolaphier="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/dimension/hierarchy" xmlns:rolaplev="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/dimension/hierarchy/level" xmlns:rolapmeas="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/cube/measure" xmlns:rolapsrc="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/database/source">
  <rolapcube:PhysicalCube xmi:id="_physicalcube_descriptionroleplayingdimensionsdb" name="DescriptionRolePlayingDimensionsDB" source="_tablesource_fact">
  ...
  <rolapsrc:JoinSource xmi:id="_joinsource">
    <left xmi:id="_joinedqueryelement_productsubcategorykey" key="_column_product_productsubcategorykey" source="_tablesource_product"/>
    <right xmi:id="_joinedqueryelement_productsubcategorykey_1" source="_tablesource_productsubcategory">
  ...
  <rolaplev:Level xmi:id="_level_rownumber" name="RowNumber">
    <column href="_column_productsubcategory_rownumber"/>
  </rolaplev:Level>
  ...
  <rolaplev:Level xmi:id="_level_rownumber_1" name="RowNumber" column="_column_product_rownumber"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_productkey" primaryKey="_column_product_productkey" source="_joinsource_1" levels="_level_rownumber_3 _level_productcategorykey _level_productcategoryalternatekey _level_englishproductcategoryname _level_spanishproductcategoryname _level_frenchproductcategoryname"/>
  <rolaplev:Level xmi:id="_level_productsubcategorykey" name="ProductSubcategoryKey">
  ...
  <rolapdim:StandardDimension xmi:id="_standarddimension_dimproduct" name="DimProduct" hierarchies="_explicithierarchy_productkey_1"/>
  ...
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_productkey_1" primaryKey="_column_product_productkey" source="_tablesource_product" levels="_level_rownumber_1 _level_productkey _level_productalternatekey _level_productsubcategorykey_1 _level_weightunitmeasurecode _level_sizeunitmeasurecode _level_englishproductname _level_spanishproductname _level_frenchproductname _level_standardcost _level_finishedgoodsflag _level_color _level_safetystocklevel _level_reorderpoint _level_listprice _level_size _level_sizerange _level_weight _level_daystomanufacture _level_productline _level_dealerprice _level_class _level_style _level_modelname _level_englishdescription _level_frenchdescription _level_chinesedescription _level_arabicdescription _level_hebrewdescription _level_thaidescription _level_startdate _level_enddate _level_status _level_subcategory"/>
  <rolaplev:Level xmi:id="_level_frenchcountryregionname" name="FrenchCountryRegionName">
    <column href="_column_geography_frenchcountryregionname"/>
  </rolaplev:Level>
  ...
  <rolaplev:Level xmi:id="_level_rownumber_2" name="RowNumber" column="_column_employee_rownumber"/>
  <rolaplev:Level xmi:id="_level_startdate" name="StartDate" column="_column_product_startdate"/>
  <rolaplev:Level xmi:id="_level_birthdate" name="BirthDate" column="_column_customer_birthdate" columnType="String"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_productkey_2" primaryKey="_column_product_productkey" source="_joinsource" levels="_level_rownumber _level_productsubcategorykey _level_productsubcategoryalternatekey _level_englishproductsubcategoryname _level_spanishproductsubcategoryname _level_frenchproductsubcategoryname _level_productcategorykey_1"/>
  <rolaplev:Level xmi:id="_level_subcategory" name="Subcategory" column="_column_product_subcategory"/>
  ...
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_geographykey" source="_joinsource_3" levels="_level_rownumber_7 _level_geographykey _level_city _level_stateprovincecode _level_stateprovincename _level_countryregioncode _level_englishcountryregionname _level_spanishcountryregionname _level_frenchcountryregionname _level_postalcode _level_salesterritorykey_1">
  ...
  <rolaplev:Level xmi:id="_level_stateprovincename" name="StateProvinceName">
    <column href="_column_geography_stateprovincename"/>
  </rolaplev:Level>
  ...
  <rolaplev:Level xmi:id="_level_rownumber_3" name="RowNumber">
  ...
  <rolaplev:Level xmi:id="_level_rownumber_4" name="RowNumber" column="_column_time_rownumber"/>
  ...
  <rolaplev:Level xmi:id="_level_productsubcategorykey_1" name="ProductSubcategoryKey" column="_column_product_productsubcategorykey"/>
  ...
  <rolaplev:Level xmi:id="_level_rownumber_5" name="RowNumber" column="_column_store_rownumber"/>
  ...
  <rolapsrc:JoinSource xmi:id="_joinsource_1">
    <left xmi:id="_joinedqueryelement_productsubcategorykey_2" key="_column_product_productsubcategorykey" source="_tablesource_product"/>
    <right xmi:id="_joinedqueryelement_productsubcategorykey_3" key="_column_productsubcategory_productsubcategorykey" source="_joinsource_2"/>
  </rolapsrc:JoinSource>
  ...
  <rolaplev:Level xmi:id="_level_phone" name="Phone" column="_column_customer_phone"/>
  ...
  <rolaplev:Level xmi:id="_level_spanishcountryregionname" name="SpanishCountryRegionName">
    <column href="_column_geography_spanishcountryregionname"/>
  </rolaplev:Level>
  ...
  <rolaplev:Level xmi:id="_level_phone_1" name="Phone" column="_column_employee_phone"/>
  ...
  <rolaplev:Level xmi:id="_level_rownumber_6" name="RowNumber" column="_column_customer_rownumber" columnType="Integer" uniqueMembers="true"/>
  ...
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_employeekey" primaryKey="_column_employee_employeekey" source="_tablesource_employee" levels="_level_rownumber_2 _level_employeekey _level_parentemployeekey _level_employeenationalidalternatekey _level_parentemployeenationalidalternatekey _level_salesterritorykey _level_firstname _level_lastname_1 _level_middlename_1 _level_namestyle_1 _level_title _level_hiredate _level_birthdate_1 _level_loginid _level_emailaddress _level_phone_1 _level_maritalstatus_1 _level_emergencycontactname _level_emergencycontactphone _level_salariedflag _level_gender _level_payfrequency _level_baserate _level_vacationhours _level_sickleavehours _level_currentflag _level_salespersonflag _level_departmentname _level_startdate_1 _level_enddate_1 _level_status_1"/>
  ...
  <rolapsrc:JoinSource xmi:id="_joinsource_2">
    <left xmi:id="_joinedqueryelement_productcategorykey" key="_column_productsubcategory_productcategorykey" source="_tablesource_productsubcategory"/>
    <right xmi:id="_joinedqueryelement_productcategorykey_1" source="_tablesource_productcategory">
  ...
  <rolapdim:StandardDimension xmi:id="_standarddimension_dimproductcategory" name="DimProductCategory" hierarchies="_explicithierarchy_productkey"/>
  ...
  <rolaplev:Level xmi:id="_level_stateprovincecode" name="StateProvinceCode">
    <column href="_column_geography_stateprovincecode"/>
  </rolaplev:Level>
  ...
  <rolaplev:Level xmi:id="_level_startdate_1" name="StartDate" column="_column_employee_startdate"/>
  ...
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_storekey" primaryKey="_column_store_storekey" source="_tablesource_store" levels="_level_rownumber_5 _level_storekey _level_geography_key _level_storename _level_number_of_employees _level_sales"/>
  ...
  <rolapsrc:JoinSource xmi:id="_joinsource_3">
    <left xmi:id="_joinedqueryelement_geographykey" key="_column_customer_geographykey" source="_tablesource_customer"/>
    <right xmi:id="_joinedqueryelement_geographykey_1" key="_column_geography_geographykey" source="_tablesource_geography"/>
  </rolapsrc:JoinSource>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_customerkey" primaryKey="_column_customer_customerkey" source="_tablesource_customer" levels="_level_rownumber_6 _level_customerkey _level_customeralternatekey _level_firstname_1 _level_middlename _level_lastname _level_namestyle _level_birthdate _level_maritalstatus _level_suffix _level_gender_1 _level_emailaddress_1 _level_yearlyincome _level_totalchildren _level_numberchildrenathome _level_englisheducation _level_spanisheducation _level_frencheducation _level_englishoccupation _level_spanishoccupation _level_frenchoccupation _level_houseownerflag _level_numbercarsowned _level_addressline1 _level_addressline2 _level_phone _level_datefirstpurchase _level_commutedistance"/>
...
<xmi:XMI xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:relational="http://www.omg.org/spec/CWM/1.1/resource/relational" xmlns:rolapcat="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/catalog" xmlns:rolapcube="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/cube" xmlns:rolapdim="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/dimension" xmlns:rolaphier="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/dimension/hierarchy" xmlns:rolaplev="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/dimension/hierarchy/level" xmlns:rolapmeas="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/olap/cube/measure" xmlns:rolapsrc="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping/database/source">
  <relational:SQLSimpleType xmi:id="_sqlsimpletype_boolean" name="BOOLEAN" structuralFeature="_column_employee_salariedflag _column_employee_currentflag _column_product_finishedgoodsflag _column_customer_namestyle _column_employee_namestyle _column_employee_salespersonflag" typeNumber="16"/>
  <relational:SQLSimpleType xmi:id="_sqlsimpletype_character_varying" name="CHARACTER VARYING" structuralFeature="_column_product_chinesedescription _column_customer_addressline1 _column_customer_addressline2 _column_product_arabicdescription _column_time_calendaryear _column_fact_carriertrackingnumber _column_geography_city _column_product_class _column_product_color _column_customer_commutedistance _column_geography_countryregioncode _column_customer_customeralternatekey _column_fact_customerponumber _column_employee_departmentname _column_employee_emailaddress _column_customer_emailaddress _column_employee_emergencycontactname _column_employee_emergencycontactphone _column_employee_employeenationalidalternatekey _column_geography_englishcountryregionname _column_time_englishdaynameofweek _column_product_englishdescription _column_customer_englisheducation _column_time_englishmonthname _column_customer_englishoccupation _column_productcategory_englishproductcategoryname _column_product_englishproductname _column_productsubcategory_englishproductsubcategoryname _column_customer_firstname _column_employee_firstname _column_time_fiscalyear _column_geography_frenchcountryregionname _column_time_frenchdaynameofweek _column_product_frenchdescription _column_customer_frencheducation _column_time_frenchmonthname _column_customer_frenchoccupation _column_productcategory_frenchproductcategoryname _column_product_frenchproductname _column_productsubcategory_frenchproductsubcategoryname _column_customer_gender _column_employee_gender _column_product_hebrewdescription _column_customer_houseownerflag _column_employee_lastname _column_customer_lastname _column_employee_loginid _column_employee_maritalstatus _column_customer_maritalstatus _column_customer_middlename _column_employee_middlename _column_product_modelname _column_customer_numbercarsowned _column_employee_parentemployeenationalidalternatekey _column_employee_phone _column_customer_phone _column_geography_postalcode _column_product_productalternatekey _column_product_productline _column_fact_salesorderlinenumber _column_product_size _column_product_sizerange _column_product_sizeunitmeasurecode _column_geography_spanishcountryregionname _column_time_spanishdaynameofweek _column_customer_spanisheducation _column_time_spanishmonthname _column_customer_spanishoccupation _column_productcategory_spanishproductcategoryname _column_product_spanishproductname _column_productsubcategory_spanishproductsubcategoryname _column_geography_stateprovincecode _column_geography_stateprovincename _column_product_status _column_employee_status _column_store_storename _column_product_style _column_product_subcategory _column_customer_suffix _column_product_thaidescription _column_employee_title _column_product_weightunitmeasurecode" typeNumber="12"/>
  <relational:SQLSimpleType xmi:id="_sqlsimpletype_date" name="DATE" structuralFeature="_column_customer_birthdate _column_employee_birthdate _column_customer_datefirstpurchase _column_employee_enddate _column_product_enddate _column_time_fulldatealternatekey _column_employee_hiredate _column_employee_startdate _column_product_startdate" typeNumber="91"/>
  <relational:SQLSimpleType xmi:id="_sqlsimpletype_decimal" name="DECIMAL" structuralFeature="_column_store_sales _column_employee_baserate _column_product_dealerprice _column_fact_extendedamount _column_fact_freight _column_product_listprice _column_fact_salesamount _column_product_standardcost _column_fact_taxamt _column_fact_totalproductcost _column_fact_unitpricediscountpct _column_customer_yearlyincome" typeNumber="3" numericPrecision="18" numericPrecisionRadix="10" numericScale="4"/>
  <relational:SQLSimpleType xmi:id="_sqlsimpletype_double_precision" name="DOUBLE PRECISION" structuralFeature="_column_product_weight _column_fact_discountamount _column_fact_productstandardcost" typeNumber="8" numericPrecisionRadix="2"/>
  <relational:SQLSimpleType xmi:id="_sqlsimpletype_integer" name="INTEGER" structuralFeature="_column_customer_customerkey _column_fact_billingcustomerkey _column_time_calendarquarter _column_time_calendarsemester _column_fact_currencykey _column_fact_customerkey _column_time_daynumberofmonth _column_time_daynumberofweek _column_time_daynumberofyear _column_product_daystomanufacture _column_fact_duedatekey _column_fact_employeekey _column_employee_employeekey _column_time_fiscalquarter _column_time_fiscalsemester _column_store_geography_key _column_geography_geographykey _column_customer_geographykey _column_time_monthnumberofyear _column_store_number_of_employees _column_customer_numberchildrenathome _column_fact_orderdatekey _column_fact_orderquantity _column_employee_parentemployeekey _column_employee_payfrequency _column_productcategory_productcategoryalternatekey _column_productcategory_productcategorykey _column_productsubcategory_productcategorykey _column_product_productkey _column_fact_productkey _column_productsubcategory_productsubcategoryalternatekey _column_productsubcategory_productsubcategorykey _column_product_productsubcategorykey _column_fact_promotionkey _column_product_reorderpoint _column_fact_revisionnumber _column_productsubcategory_rownumber _column_geography_rownumber _column_customer_rownumber _column_productcategory_rownumber _column_product_rownumber _column_time_rownumber _column_store_rownumber _column_employee_rownumber _column_fact_rownumber _column_product_safetystocklevel _column_fact_salesordernumber _column_employee_salesterritorykey _column_geography_salesterritorykey _column_fact_salesterritorykey _column_fact_shipdatekey _column_employee_sickleavehours _column_store_storekey _column_fact_storekey _column_time_timekey _column_customer_totalchildren _column_fact_totalsales _column_fact_unitprice _column_employee_vacationhours _column_time_weeknumberofyear" typeNumber="4"/>
  ...
  <relational:Schema xmi:id="_schema">
    <ownedElement xsi:type="relational:Table" xmi:id="_table_fact" name="Fact">
      ...
      <feature xsi:type="relational:Column" xmi:id="_column_fact_salesterritorykey" name="SalesTerritoryKey" type="_sqlsimpletype_integer" isNullable="columnNullable"/>
    ...
    <ownedElement xsi:type="relational:Table" xmi:id="_table_customer" name="Customer">
      ...
      <feature xsi:type="relational:Column" xmi:id="_column_customer_middlename" name="MiddleName" type="_sqlsimpletype_character_varying" isNullable="columnNullable"/>
      ...
      <feature xsi:type="relational:Column" xmi:id="_column_customer_suffix" name="Suffix" type="_sqlsimpletype_character_varying" isNullable="columnNullable"/>
      ...
      <feature xsi:type="relational:Column" xmi:id="_column_customer_addressline2" name="AddressLine2" type="_sqlsimpletype_character_varying" isNullable="columnNullable"/>
    ...
    <ownedElement xsi:type="relational:Table" xmi:id="_table_employee" name="Employee">
      ...
      <feature xsi:type="relational:Column" xmi:id="_column_employee_parentemployeenationalidalternatekey" name="ParentEmployeeNationalIDAlternateKey" type="_sqlsimpletype_character_varying" isNullable="columnNullable"/>
      <feature xsi:type="relational:Column" xmi:id="_column_employee_salesterritorykey" name="SalesTerritoryKey" type="_sqlsimpletype_integer" isNullable="columnNullable"/>
      ...
      <feature xsi:type="relational:Column" xmi:id="_column_employee_middlename" name="MiddleName" type="_sqlsimpletype_character_varying" isNullable="columnNullable"/>
      ...
      <feature xsi:type="relational:Column" xmi:id="_column_employee_enddate" name="EndDate" type="_sqlsimpletype_date" isNullable="columnNullable"/>
    ...
    <ownedElement xsi:type="relational:Table" xmi:id="_table_geography" name="Geography">
      ...
      <feature xsi:type="relational:Column" xmi:id="_column_geography_stateprovincecode" name="StateProvinceCode" type="_sqlsimpletype_character_varying" isNullable="columnNullable"/>
      ...
      <feature xsi:type="relational:Column" xmi:id="_column_geography_salesterritorykey" name="SalesTerritoryKey" type="_sqlsimpletype_integer" isNullable="columnNullable"/>
    </ownedElement>
    <ownedElement xsi:type="relational:Table" xmi:id="_table_product" name="Product">
      ...
      <feature xsi:type="relational:Column" xmi:id="_column_product_sizerange" name="SizeRange" type="_sqlsimpletype_character_varying" isNullable="columnNullable"/>
      ...
      <feature xsi:type="relational:Column" xmi:id="_column_product_productline" name="ProductLine" type="_sqlsimpletype_character_varying" isNullable="columnNullable"/>
      ...
      <feature xsi:type="relational:Column" xmi:id="_column_product_enddate" name="EndDate" type="_sqlsimpletype_date" isNullable="columnNullable"/>
  ...
  <rolapsrc:TableSource xmi:id="_tablesource_product" table="_table_product"/>
  <rolapsrc:JoinSource xmi:id="_joinsource">
    <left xmi:id="_joinedqueryelement_geographykey_1" key="_column_customer_geographykey" source="_tablesource_customer"/>
    <right xmi:id="_joinedqueryelement_geographykey" key="_column_geography_geographykey" source="_tablesource_geography"/>
  </rolapsrc:JoinSource>
  <rolapsrc:JoinSource xmi:id="_joinsource_1">
    <left xmi:id="_joinedqueryelement_productsubcategorykey" key="_column_product_productsubcategorykey" source="_tablesource_product"/>
    <right xmi:id="_joinedqueryelement_productsubcategorykey_2" key="_column_productsubcategory_productsubcategorykey" source="_joinsource_2"/>
  </rolapsrc:JoinSource>
  <rolapsrc:JoinSource xmi:id="_joinsource_2">
    <left xmi:id="_joinedqueryelement_productcategorykey_1" key="_column_productsubcategory_productcategorykey" source="_tablesource_productsubcategory"/>
    <right xmi:id="_joinedqueryelement_productcategorykey" key="_column_productcategory_productcategorykey" source="_tablesource_productcategory"/>
  </rolapsrc:JoinSource>
  <rolapsrc:JoinSource xmi:id="_joinsource_3">
    <left xmi:id="_joinedqueryelement_productsubcategorykey_1" key="_column_product_productsubcategorykey" source="_tablesource_product"/>
    <right xmi:id="_joinedqueryelement_productsubcategorykey_3" key="_column_productsubcategory_productsubcategorykey" source="_tablesource_productsubcategory"/>
  </rolapsrc:JoinSource>
  <rolaplev:Level xmi:id="_level_addressline1" name="AddressLine1" column="_column_customer_addressline1"/>
  <rolaplev:Level xmi:id="_level_addressline2" name="AddressLine2" column="_column_customer_addressline2"/>
  <rolaplev:Level xmi:id="_level_arabicdescription" name="ArabicDescription" column="_column_product_arabicdescription"/>
  ...
  <rolaplev:Level xmi:id="_level_hiredate" name="HireDate" column="_column_employee_hiredate"/>
  <rolaplev:Level xmi:id="_level_houseownerflag" name="HouseOwnerFlag" column="_column_customer_houseownerflag"/>
  <rolaplev:Level xmi:id="_level_lastname" name="LastName" column="_column_employee_lastname"/>
  <rolaplev:Level xmi:id="_level_lastname_1" name="LastName" column="_column_customer_lastname" columnType="String"/>
  <rolaplev:Level xmi:id="_level_listprice" name="ListPrice" column="_column_product_listprice"/>
  <rolaplev:Level xmi:id="_level_loginid" name="LoginID" column="_column_employee_loginid"/>
  <rolaplev:Level xmi:id="_level_maritalstatus" name="MaritalStatus" column="_column_employee_maritalstatus"/>
  <rolaplev:Level xmi:id="_level_maritalstatus_1" name="MaritalStatus" column="_column_customer_maritalstatus" columnType="String"/>
  <rolaplev:Level xmi:id="_level_middlename" name="MiddleName" column="_column_customer_middlename" columnType="String"/>
  <rolaplev:Level xmi:id="_level_middlename_1" name="MiddleName" column="_column_employee_middlename"/>
  <rolaplev:Level xmi:id="_level_modelname" name="ModelName" column="_column_product_modelname"/>
  <rolaplev:Level xmi:id="_level_monthnumberofyear" name="MonthNumberOfYear" column="_column_time_monthnumberofyear"/>
  ...
  <rolaplev:Level xmi:id="_level_reorderpoint" name="ReorderPoint" column="_column_product_reorderpoint"/>
  <rolaplev:Level xmi:id="_level_rownumber" name="RowNumber" column="_column_employee_rownumber"/>
  <rolaplev:Level xmi:id="_level_rownumber_1" name="RowNumber" column="_column_productcategory_rownumber"/>
  <rolaplev:Level xmi:id="_level_rownumber_2" name="RowNumber" column="_column_store_rownumber"/>
  <rolaplev:Level xmi:id="_level_rownumber_3" name="RowNumber" column="_column_time_rownumber"/>
  <rolaplev:Level xmi:id="_level_rownumber_4" name="RowNumber" column="_column_geography_rownumber"/>
  <rolaplev:Level xmi:id="_level_rownumber_5" name="RowNumber" column="_column_customer_rownumber" columnType="Integer" uniqueMembers="true"/>
  <rolaplev:Level xmi:id="_level_rownumber_6" name="RowNumber" column="_column_productsubcategory_rownumber"/>
  <rolaplev:Level xmi:id="_level_rownumber_7" name="RowNumber" column="_column_product_rownumber"/>
  <rolaplev:Level xmi:id="_level_safetystocklevel" name="SafetyStockLevel" column="_column_product_safetystocklevel"/>
  <rolaplev:Level xmi:id="_level_salariedflag" name="SalariedFlag" column="_column_employee_salariedflag"/>
  <rolaplev:Level xmi:id="_level_sales" name="Sales" column="_column_store_sales"/>
  <rolaplev:Level xmi:id="_level_salespersonflag" name="SalesPersonFlag" column="_column_employee_salespersonflag"/>
  ...
  <rolaplev:Level xmi:id="_level_weightunitmeasurecode" name="WeightUnitMeasureCode" column="_column_product_weightunitmeasurecode"/>
  <rolaplev:Level xmi:id="_level_yearlyincome" name="YearlyIncome" column="_column_customer_yearlyincome" columnType="Numeric"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_storekey" primaryKey="_column_store_storekey" source="_tablesource_store" levels="_level_rownumber_2 _level_storekey _level_geography_key _level_storename _level_number_of_employees _level_sales"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_productkey" primaryKey="_column_product_productkey" source="_joinsource_1" levels="_level_rownumber_1 _level_productcategorykey_1 _level_productcategoryalternatekey _level_englishproductcategoryname _level_spanishproductcategoryname _level_frenchproductcategoryname"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_productkey_1" primaryKey="_column_product_productkey" source="_joinsource_3" levels="_level_rownumber_6 _level_productsubcategorykey_1 _level_productsubcategoryalternatekey _level_englishproductsubcategoryname _level_spanishproductsubcategoryname _level_frenchproductsubcategoryname _level_productcategorykey"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_geographykey" primaryKey="_column_geography_geographykey" source="_joinsource" levels="_level_rownumber_4 _level_geographykey _level_city _level_stateprovincecode _level_stateprovincename _level_countryregioncode _level_englishcountryregionname _level_spanishcountryregionname _level_frenchcountryregionname _level_postalcode _level_salesterritorykey"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_timekey" primaryKey="_column_time_timekey" source="_tablesource_time" levels="_level_rownumber_3 _level_timekey _level_fulldatealternatekey _level_daynumberofweek _level_englishdaynameofweek _level_spanishdaynameofweek _level_frenchdaynameofweek _level_daynumberofmonth _level_daynumberofyear _level_weeknumberofyear _level_englishmonthname _level_spanishmonthname _level_frenchmonthname _level_monthnumberofyear _level_calendarquarter _level_calendaryear _level_calendarsemester _level_fiscalquarter _level_fiscalyear _level_fiscalsemester"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_productkey_2" primaryKey="_column_product_productkey" source="_tablesource_product" levels="_level_rownumber_7 _level_productkey _level_productalternatekey _level_productsubcategorykey _level_weightunitmeasurecode _level_sizeunitmeasurecode _level_englishproductname _level_spanishproductname _level_frenchproductname _level_standardcost _level_finishedgoodsflag _level_color _level_safetystocklevel _level_reorderpoint _level_listprice _level_size _level_sizerange _level_weight _level_daystomanufacture _level_productline _level_dealerprice _level_class _level_style _level_modelname _level_englishdescription _level_frenchdescription _level_chinesedescription _level_arabicdescription _level_hebrewdescription _level_thaidescription _level_startdate _level_enddate _level_status_1 _level_subcategory"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_customerkey" primaryKey="_column_customer_customerkey" source="_tablesource_customer" levels="_level_rownumber_5 _level_customerkey _level_customeralternatekey _level_firstname_1 _level_middlename _level_lastname_1 _level_namestyle _level_birthdate _level_maritalstatus_1 _level_suffix _level_gender_1 _level_emailaddress_1 _level_yearlyincome _level_totalchildren _level_numberchildrenathome _level_englisheducation _level_spanisheducation _level_frencheducation _level_englishoccupation _level_spanishoccupation _level_frenchoccupation _level_houseownerflag _level_numbercarsowned _level_addressline1 _level_addressline2 _level_phone _level_datefirstpurchase _level_commutedistance"/>
  <rolaphier:ExplicitHierarchy xmi:id="_explicithierarchy_employeekey" primaryKey="_column_employee_employeekey" source="_tablesource_employee" levels="_level_rownumber _level_employeekey _level_parentemployeekey _level_employeenationalidalternatekey _level_parentemployeenationalidalternatekey _level_salesterritorykey_1 _level_firstname _level_lastname _level_middlename_1 _level_namestyle_1 _level_title _level_hiredate _level_birthdate_1 _level_loginid _level_emailaddress _level_phone_1 _level_maritalstatus _level_emergencycontactname _level_emergencycontactphone _level_salariedflag _level_gender _level_payfrequency _level_baserate _level_vacationhours _level_sickleavehours _level_currentflag _level_salespersonflag _level_departmentname _level_startdate_1 _level_enddate_1 _level_status"/>
  <rolapdim:StandardDimension xmi:id="_standarddimension_dimcustomer" name="DimCustomer" hierarchies="_explicithierarchy_customerkey"/>
  <rolapdim:StandardDimension xmi:id="_standarddimension_dimemployee" name="DimEmployee" hierarchies="_explicithierarchy_employeekey"/>
  <rolapdim:StandardDimension xmi:id="_standarddimension_dimgeography" name="DimGeography" hierarchies="_explicithierarchy_geographykey"/>
  <rolapdim:StandardDimension xmi:id="_standarddimension_dimproduct" name="DimProduct" hierarchies="_explicithierarchy_productkey_2"/>
  <rolapdim:StandardDimension xmi:id="_standarddimension_dimproductcategory" name="DimProductCategory" hierarchies="_explicithierarchy_productkey"/>
