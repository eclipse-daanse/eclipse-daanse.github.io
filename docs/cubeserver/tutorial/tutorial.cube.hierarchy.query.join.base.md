...
```xml
<roma:ExplicitHierarchy  id="_hierarchy_town" name="TownHierarchy" primaryKey="_col_town_id" query="_query_LevelTownToCountry" levels="_level_town _level_country"/>
