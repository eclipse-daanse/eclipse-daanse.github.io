---
title: Minimal_Cube_with_cube_dimension_level_with_parent_child_with_null_parent_value
group: Unstrutured
kind: other
number: z0
---
...
<xmi:XMI xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:roma="https://www.daanse.org/spec/org.eclipse.daanse.rolap.mapping">
  <roma:ParentChildHierarchy id="hierarchy" allMemberName="All" hasAll="true" primaryKey="_parent_name" query="FactQuery" nullParentValue="all" parentColumn="_parent_parent" level="_level_name"/>
  <roma:Catalog description="Schema of a minimal cube with cube dimension level with parent child with null parent value" name="Minimal_Cube_with_cube_dimension_level_with_parent_child_with_null_parent_value" cubes="Cube" dbschemas="databaseSchema"/>
...
<a href="./zip/tutorial.cube.hierarchy.parentchild.nullparent.zip" download>Download Zip File</a>
